...
const Navbar = () => {
  ...
  const navItems = (
    <>
      ...
      <li>
        <a href="/offer" className={`text-${isDarkMode ? "white" : "black"}`}>Offers</a>
      </li>
    </>
  );
  return (
    <header
      className={`w-full z-10  mx-auto fixed top-0 left-0 right-0 transition-all duration-300 ease-in-out ${
        isDarkMode ? "dark" : ""
      }`}
    >
      <div
